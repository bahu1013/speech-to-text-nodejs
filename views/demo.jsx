...
export class Demo extends Component {
  ...
  handleHideClick(){
	  if(this.state.commentHide == false){
		this.setState({ commentHide: true });
	  }else{
		this.setState({ commentHide: false });
	  }
  } 	
  ...
  render() {
    const {
      ...
      formattedMessages, rawMessages,commentHide,
    } = this.state;
			 ...
			 <div className="flex top-header">
				<div className="record-logo">
					<button type="button" className={micButtonClass} onClick={this.handleMicClick}>
						<Icon type={audioSource === 'mic' ? 'stop' : 'microphone'} fill={micIconFill} />
					 </button>	
				</div>
				<div className="middle-column">
					<div className="column">
						...
						<p><input
						  ...
						  className="base--input search-text"
						/>
						</p>
				...
				<div className="left-side">
					<div className="buttons">
					  <button id="play-icon" type="button" className={audioSource === 'sample-1' ? 'stop' : 'play'} onClick={this.handleSample1Click}>
						
						{/* <Icon type={audioSource === 'sample-1' ? 'stop' : 'play' /> */}
					  </button>
					  <button id="file-icon" type="button" className={audioSource === 'upload' ? 'stop' : 'upload'} onClick={this.handleUploadClick}>
						{/*<Icon type={audioSource === 'upload' ? 'stop' : 'upload'} /> */}
					  </button>
					  <button id="comment-icon" type="button" onClick={this.handleHideClick}>
 ...
 <div className="card">
       ...
       <AudioSpectrum
		...
		/>
			 ...
			 {err}
			 <div className={commentHide === true ? 'commentHide' : ''}>
			 <div className="tab-block">
				<Tabs selected={0}>
				  <Pane label="Text">
					{settingsAtStreamStart.speakerLabels
					  ? <SpeakersView messages={messages} keywords={this.getKeywordsArrUnique()} />
					  : <Transcript messages={messages} keywords={this.getKeywordsArrUnique()} />}
				  </Pane>
		...
		<div className="info-logo">
			<div className="info-tooltip">
				<p><b>Transcribe Audio</b> The returned result includes the recognized text, word alternatives, and spotted keywords. Some models can detect multiple speakers this may slow down performance.</p>
			</div>
